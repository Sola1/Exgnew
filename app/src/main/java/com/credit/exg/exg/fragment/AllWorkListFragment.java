...
public class AllWorkListFragment extends BaseFragment {
    ...
    public static Fragment createListViewFragment() {
        Fragment fragment = new AllWorkListFragment();
        return fragment;
    }
    ...
    public View createView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.frag_all_work_list, container, false);
    }
